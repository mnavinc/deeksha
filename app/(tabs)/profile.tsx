...
const styles = StyleSheet.create({
  ...
  card: {
    padding: spacing.md, borderWidth: 1, borderRadius: 14, gap: 6,
  },
  ...
  signOutBtn: {
    ...
    padding: 14, borderWidth: 1.5, borderRadius: 12, marginTop: 8,
  },
  signOutText: { fontWeight: '700', fontSize: 14 },
  empty: {
    flex: 1, justifyContent: 'center', alignItems: 'center', padding: spacing.lg, gap: 12,
  },
