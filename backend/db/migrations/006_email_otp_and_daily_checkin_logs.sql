...
CREATE INDEX IF NOT EXISTS email_otp_identifier_idx ON email_otp_codes(identifier, expires_at DESC);
CREATE INDEX IF NOT EXISTS daily_checkin_user_date_idx ON daily_checkin_logs(user_id, checkin_date DESC);
